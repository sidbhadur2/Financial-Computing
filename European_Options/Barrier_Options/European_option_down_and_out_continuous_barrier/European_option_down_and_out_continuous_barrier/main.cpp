...
int main (int argc, char* argv[])
{
    ...
    for (int j = 0; j < no_of_trials; j++) {
        ...
        adj_call_price += ( (p_adjustment(S1)* maxS1) + (p_adjustment(S2)* maxS2) + (p_adjustment(S3)* maxS3) + (p_adjustment(S4)* maxS4)) / 4.0;
        ...
        adj_put_price += ( (p_adjustment(S1)* minS1) + (p_adjustment(S2)* minS2) + (p_adjustment(S3)* minS3) + (p_adjustment(S4)* minS4)) / 4.0;
