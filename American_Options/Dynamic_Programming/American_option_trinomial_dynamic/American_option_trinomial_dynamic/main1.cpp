//
//  main.cpp
//  American_option_trinomial_dynamic
//
//  Created by Siddharth Bhaduri on 11/9/16.
...
double american_call_option_dyn_prog()
{
    ...
    transition_probability(1,1) = notick_prob;
    transition_probability(1,2) = 1 - notick_prob;
...
int main (int argc, char* argv[])
{
    ...
    cout << "Uptick Probability = " << downtick_prob << endl;
